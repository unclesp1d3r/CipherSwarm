...
conditions:
  - field: file_path
    ...
    pattern: (db/schema\.rb|db/structure\.sql|node_modules/|yarn\.lock|Gemfile\.lock|package-lock\.json)
---

⚙️ **Auto-Generated File Edit Detected!**

You're editing a file that is automatically generated and should not be modified manually.

**Detected file types:**

📁 **Database Schema** (`db/schema.rb` or `db/structure.sql`)
...
❌ Don't: Edit schema.rb to add a column ✅ Do: `bin/rails generate migration AddColumnToUsers email:string`

❌ Don't: Modify Gemfile.lock versions manually ✅ Do: `bundle update specific_gem`

❌ Don't: Change code in node_modules/ ✅ Do: Fork the package or submit a PR upstream
