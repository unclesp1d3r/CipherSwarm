...
class CreateAgents < ActiveRecord::Migration[7.1]
  def change
    create_table :agents do |t|
      ...
      t.boolean :cpu_only, default: false, comment: "Only use for CPU only tasks", null: false
      t.boolean :ignore_errors, default: false, comment: "Ignore errors, continue to next task", null: false
      t.boolean :active, default: true, comment: "Is the agent active", null: false
      t.boolean :trusted, default: false, comment: "Is the agent trusted to handle sensitive data", null: false
