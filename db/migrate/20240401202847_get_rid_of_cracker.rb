  ...
  def change
    reversible do |direction|
      ...
      direction.down do
        ...
        add_column :cracker_binaries, :cracker_id, :bigint, null: false,
                                                            comment: "The cracker that this binary belongs to", default: 1
        add_column :operations, :cracker_id, :bigint, null: false, comment: "The cracker that this operation is using",
                                                      default: 1
      end
    end
  end
