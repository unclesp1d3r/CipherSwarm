...
-   [x] Complete all tasks in `docs/v2_rewrite_implementation_plan/side_quests/crackable_uploads_plan.md` (this is a side quest and should be completed after the main tasks are complete) `task_id:upload.crackable_uploads_side_quest`
