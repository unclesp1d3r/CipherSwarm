...
<svelte:head>
    <title>Edit Campaign - CipherSwarm</title>
</svelte:head>

<Dialog.Root bind:open onOpenChange={handleClose}>
    <Dialog.Content class="sm:max-w-md">
        <Dialog.Header>
            <Dialog.Title data-testid="modal-title">Edit Campaign</Dialog.Title>
            <Dialog.Description>Update campaign details</Dialog.Description>
        </Dialog.Header>
