  ...
  describe "lifecycle logging" do
    describe "#shutdown" do
      ...
      it "skips pause for a running task where can_pause? returns false" do
        ...
        # Stub can_pause? to return false so the task is not paused
        allow_any_instance_of(Task).to receive(:can_pause?).and_return(false) # rubocop:disable RSpec/AnyInstance

        agent.shutdown

        # Task should remain running since can_pause? returned false
