...
RSpec.describe "RuleLists" do
  ...
  describe "POST /create" do
    ...
    context "when a project user is signed in" do
      ...
      it "fails to create rule list with unauthorized project IDs" do
        ...
        sign_in project_user
        post rule_lists_path, params: params_with_unauthorized_project
        expect(response).to have_http_status(:forbidden)
      ...
      it "fails gracefully with non-existent project IDs" do
        ...
        sign_in project_user
        post rule_lists_path, params: params_with_invalid_project
      ...
      it "handles empty string in project_ids array" do
        ...
        sign_in project_user
        post rule_lists_path, params: params_with_empty_strings
        expect(response).to redirect_to(rule_list_path(RuleList.last))
        expect(RuleList.last.projects).to be_empty
        expect(RuleList.last.sensitive).to be false
      end
    end
  end
end
