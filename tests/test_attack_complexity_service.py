...
def test_mask_attack_simple() -> None:
    ...
    assert calculate_attack_complexity(attack) == 17576  # type: ignore[arg-type]  # noqa: PLR2004
...
def test_mask_attack_multiple() -> None:
    ...
    attack = StubAttack(mask_list=mask_list)
    assert calculate_attack_complexity(attack) == 776  # type: ignore[arg-type]  # noqa: PLR2004
